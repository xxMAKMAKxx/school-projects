<?php
// source: /data/web/virtuals/107203/virtual/www/subdom/iis/sandbox/app/config/config.neon 
// source: /data/web/virtuals/107203/virtual/www/subdom/iis/sandbox/app/config/config.local.neon 

class Container_2d10da5ccd extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/data/web/virtuals/107203/virtual/www/subdom/iis/sandbox/app',
			'wwwDir' => '/data/web/virtuals/107203/virtual/www/subdom/iis/sandbox/www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/data/web/virtuals/107203/virtual/www/subdom/iis/sandbox/app/../temp',
		));
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/data/web/virtuals/107203/virtual/www/subdom/iis/sandbox/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/data/web/virtuals/107203/virtual/www/subdom/iis/sandbox/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/data/web/virtuals/107203/virtual/www/subdom/iis/sandbox/app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=wm94.wedos.net;dbname=d107203_iis', 'a107203_iis', 'Martin123!',
			NULL);
	...
	{
		return new Container_2d10da5ccd_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('/data/web/virtuals/107203/virtual/www/subdom/iis/sandbox/app/../temp/cache/latte');
	...
	{
		$service = new Nette\Security\SimpleAuthenticator(array('admin' => 'password'), array('admin' => NULL));
		return $service;
	}
...
final class Container_2d10da5ccd_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_2d10da5ccd $container)
	{
