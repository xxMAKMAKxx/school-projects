<?php
// source: /data/web/virtuals/107203/virtual/www/subdom/iis/sandbox/app/presenters/templates/@layout.latte

class Template3bf7814f8cc0d99f7cde222b781547b6 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('2bcd9f7b62', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb54c98294b9_head')) { function _lb54c98294b9_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb03013ec4f7_scripts')) { function _lb03013ec4f7_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
