#!/usr/bin/python
import sys, getopt, urllib2, re, os, zipfile, xmlrpclib, os.path, collections
...
def subtitlesDownload(listOfId):
	global pocitadlo
	print("Stahuji anglicke titulky k filmu...")
...
def arguments(argv): 
    ...
    url=''
    try:
        opts, args = getopt.getopt(argv, "hm:u:",["url="])
...
def titulkyID():
	...
	#END OFCREATING ADRESS FROM -F LANGAUGE
...
print("!!! Pokud presahnete tento limit nebude mozne dalsi titulky stahovat !!!")
